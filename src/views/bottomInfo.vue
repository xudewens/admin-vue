    ...
    <div id="bottom">
        <div class="left">
            ...
            <div class="footer-suggestioN">
                <img src="../assets/images/C.png" alt="" width="14px">  2024 GLOBGAME. All Rights Reserved
            </div>
            <div class="websiteTerms">
